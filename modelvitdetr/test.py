...
from datasets.bone import make_bone_transforms
...
def get_args_parser():
    ...
    # dataset parameters
    parser.add_argument('--dataset_file', default='bone')
...
def infer(images_path, model, postprocessors, device, output_path):
    ...
    for img_sample in images_path:
        ...
        w, h = orig_image.size
        transform = make_bone_transforms("val")
        dummy_target = {
        ...
        keep = probas.max(-1).values > 0.01 #args.thresh
